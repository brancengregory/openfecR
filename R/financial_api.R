...
FinancialApi <- R6::R6Class(
  ...
  public = list(
    ...
    ElectionsSearchGet = function(api.key, sort.hide.null=FALSE, per.page=20, sort.nulls.last=FALSE, district=NULL, sort.null.only=FALSE, sort=c("sort_order","district"), office=NULL, zip=NULL, state=NULL, cycle=NULL, page=1, ...){
    ...
    ElectionsSearchGetWithHttpInfo = function(api.key, sort.hide.null=FALSE, per.page=20, sort.nulls.last=FALSE, district=NULL, sort.null.only=FALSE, sort=c("sort_order","district"), office=NULL, zip=NULL, state=NULL, cycle=NULL, page=1, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
