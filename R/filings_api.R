...
FilingsApi <- R6::R6Class(
  ...
  public = list(
    ...
    FilingsGet = function(api.key, is.amended=NULL, amendment.indicator=NULL, filer.type=NULL, per.page=20, committee.id=NULL, sort=c("-receipt_date"), committee.type=NULL, primary.general.indicator=NULL, form.type=NULL, state=NULL, form.category=NULL, cycle=NULL, report.year=NULL, min.receipt.date=NULL, beginning.image.number=NULL, sort.hide.null=FALSE, max.receipt.date=NULL, file.number=NULL, sort.nulls.last=FALSE, district=NULL, candidate.id=NULL, request.type=NULL, sort.null.only=FALSE, document.type=NULL, office=NULL, most.recent=NULL, report.type=NULL, party=NULL, page=1, ...){
    ...
    OperationsLogGet = function(api.key, amendment.indicator=NULL, max.transaction.data.complete.date=NULL, max.coverage.end.date=NULL, per.page=20, status.num=NULL, min.coverage.end.date=NULL, sort=c("-report_year"), min.transaction.data.complete.date=NULL, form.type=NULL, candidate.committee.id=NULL, report.year=NULL, min.receipt.date=NULL, beginning.image.number=NULL, sort.hide.null=FALSE, max.receipt.date=NULL, sort.nulls.last=FALSE, sort.null.only=FALSE, report.type=NULL, page=1, ...){
